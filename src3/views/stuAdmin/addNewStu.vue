<template>
  <el-card class="add-student">
    ...
    <el-form ref="form11" :model="form" label-width="120px">
      ...
      <el-row>
        <el-col :span="12">
          <el-button type="primary" @click="submitForm('form11')">提交</el-button>
        </el-col>
        <el-col :span="12">
          <el-button type="primary" @click="resetForm('form11')">重置</el-button>
        </el-col>
      </el-row>
    </el-form>
  </el-card>
...
<script>
import { selectClassByStatus,addNewStudent } from "@/api/http.js";
export default {
  data() {
    return {
      form: {
